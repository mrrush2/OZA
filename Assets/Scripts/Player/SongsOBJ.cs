...
public class SongsOBJ : MonoBehaviour 
{
	...
	////// COMBO DEFINITIONS //////
	/// ("Song Name", "Part of Song", "Notes to Play it", "# of Notes Including Rests", "Damage", "Effect", "If End of Song")
	/// C Major
	public Combo MHLL1 = new Combo ("Mary Had a Little Lamb", 0, "6545666", 7, 4f, "Arpegginade", false);			// Mary Had a Little Lamb
